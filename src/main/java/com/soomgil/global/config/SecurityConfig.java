...
public class SecurityConfig {
	...
	SecurityFilterChain securityFilterChain(
		...
		return http
			...
			.authorizeHttpRequests(auth -> auth
				...
				.requestMatchers(HttpMethod.GET, "/api/v1/community/threads").permitAll()
				.requestMatchers(HttpMethod.GET, "/api/v1/community/threads/*").permitAll()
				.requestMatchers(HttpMethod.GET, "/api/v1/community/threads/*/replies").permitAll()
				...
				.requestMatchers(HttpMethod.GET, "/api/v1/award-photos").permitAll()
	...
	CorsConfigurationSource corsConfigurationSource(CorsProperties properties) {
		...
		List<String> allowedOriginPatterns = properties.allowedOriginPatternList();
